...
module.exports = [
  {
    ...
    module: {
      rules: [
        {test: /\.(jpe?g|png|ico|icns|gif|webp|bmp|svg|mp3|wav|mp4|webm|ttf|otf|pdf|txt|svg|psd)$/, exclude: webExclude, use: [{loader: "file-loader", options: {name: "[path][name].[ext]"}}]},
